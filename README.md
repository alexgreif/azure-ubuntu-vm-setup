...
This is already filtering for Standard_B type Virtual Machines. You are probably going to want to use a machine from this family for this project, but feel free to remove the filter if you are interested to see what other machines are available.
...
Once you configured all variables, use the following commands to deploy your VM:
...
Note that terraform plan will likely take a few minutes. You can use this time to familiarize yourself a little with how you could set up a VM manually in the browser.
